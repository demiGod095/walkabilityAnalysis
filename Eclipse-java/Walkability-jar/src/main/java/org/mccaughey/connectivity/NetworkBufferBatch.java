...
public class NetworkBufferBatch
{ // extends RecursiveAction {
			...
			Double bufferSize )
	{
		...
		buffers = new DefaultFeatureCollection();
		graphs = new DefaultFeatureCollection();
		pointsPerThread = 1000; // TODO: make this dynamic
	}
	...
	/**
	 * @return A SimpleFeatureCollection consisting of the buffered service
	 *         areas for each point of interest
	 * @throws IOException
	 */
...
//					LOGGER.error( "" );
	...
	private Collection<? extends SimpleFeature> createFeatures( List<Point> pointGeometries,
			SimpleFeature geometryFeature )
	{
